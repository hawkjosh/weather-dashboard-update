...
const Day1252 = ({ temperature, conditionText, ...props }) => {
	return (
		<svg
			viewBox='0 0 128 144'
			{...props}>
			<g id='weather-icon'>
				...
				<path
					id='rain'
					fill='hsl(240, 100%, 50%)'
					d='M56 110c-4 4-4 12 0 12 4 0 4-8 0-12zm12 0c-4 4-4 12 0 12 4 0 4-8 0-12z'
				/>
				<path
					id='snowflake'
					stroke='hsl(0, 0%, 90%)'
					strokeWidth='1.5'
					strokeLinecap='round'
					d='M77 116h10m-5-5v10m-4-1 8-8m0 8-8-8m13 4h10m-5-5v10m-4-1 8-8m0 8-8-8'
				/>
			</g>
