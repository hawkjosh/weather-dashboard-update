...
const Day1192 = ({ temperature, conditionText, ...props }) => {
	return (
		<svg
			viewBox='0 0 128 144'
			{...props}>
			<g id='weather-icon'>
				...
				<path
					id='rain'
					fill='hsl(240, 100%, 50%)'
					d='M56 110c-4 4-4 12 0 12 4 0 4-8 0-12zm12 0c-4 4-4 12 0 12 4 0 4-8 0-12zm12 0c-4 4-4 12 0 12 4 0 4-8 0-12zm12 0c-4 4-4 12 0 12 4 0 4-8 0-12z'
				/>
			</g>
